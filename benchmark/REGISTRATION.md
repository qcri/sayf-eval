# HF benchmark registration steps (DRAFT — hold for release)

Two one-time actions make the leaderboard live. Both are deliberately deferred
until the public-disclosure decision (with the PyPI release).
...
disputed scores. Decide the **public task subset** before this step.
